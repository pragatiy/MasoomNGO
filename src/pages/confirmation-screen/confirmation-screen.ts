   ...
   isTimeout:Boolean=false;
    ...
    constructor(public navCtrl: NavController,
        ...
        this.loading = this.loadingCtrl.create({
            content: commonString.confirmationPage.waitMsg
        });
            ...
            (result) => {
                ...
                if (sucessCode == 200) {
                    ...
                    let alert = this.alertCtrl.create({
                        subTitle: commonString.confirmationPage.regKeyErr,
                        buttons: ['Ok']
                    });
                    alert.present();
                }
                    ...
                    this.loading.dismiss();
                    let alert = this.alertCtrl.create({
                        subTitle: commonString.confirmationPage.reqFailed,
                        buttons: ['Ok']
                    });
                    alert.present();
                    ...
                    this.loading.dismiss();
                    let alert = this.alertCtrl.create({
                        subTitle: commonString.confirmationPage.userIdErr,
                        buttons: ['Ok']
                    });
                    alert.present();
                }
                    ...
                    this.loading.dismiss();
                    let alert = this.alertCtrl.create({
                        subTitle: commonString.confirmationPage.connectivityErr,
                        buttons: ['Ok']
                    });
                    alert.present();
