    ...
    AppModule = __decorate([
        NgModule({
            declarations: [MyApp, HomePage], imports: [BrowserModule, LongPressModule, HttpClientModule, HttpModule, BrowserAnimationsModule,
                ...
                UserProfilePageModule, DriveBackupPageModule, WelcomePageModule, UnlockPageModule, IconlistPageModule, PasswordPolicyPageModule, ShowTotpPageModule, IonicModule.forRoot(MyApp)], bootstrap: [IonicApp],
